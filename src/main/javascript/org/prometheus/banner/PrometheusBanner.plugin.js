                ...
                update() {
                    ...
                    if (this.settings.clientsideBanner && this.settings.bannerUrl) {
                        ...
                        this.clientsideBanner = setInterval(() => {
                            ...
                            document.querySelectorAll(`[class *= "banner-3vVQWW"]`).forEach(banner => {

                                    banner.style = `background-image: url("${this.settings.bannerUrl}"); background-size: cover; width: 300px; height: 120px;`;
                            });

<h1 align = "center"> PrometheusUser </h1>
...
Install with <a href = "https://betterdiscord.app/"> BetterDiscord </a> by placing it inside of the, `/plugins` folder. The `/plugins` folder can be in, `C:\Users\USERNAME\AppData\Roaming\BetterDiscord\plugins`
